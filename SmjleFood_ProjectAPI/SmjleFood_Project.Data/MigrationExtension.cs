...
namespace SmjleFood_Project.Data
{
    public static class MigrationExtension
    {
        public static void ConfigMigration<TDbContext>(this IApplicationBuilder app) where TDbContext : DbContext
        {
            ...
            {
                Console.WriteLine($"{DateTime.UtcNow.AddHours(7).ToString("yyyy-MM-dd HH:mm:ss.fff")}||fail: SmjleFood_Project.Data.MigrationExtension[0]\n{ex.ToString()}");
            }
        }
    }
}
